...
const Dashboard = () => {
  ...
  api.post('/user/find_user', {email})
    .then(resp=>{
      setqtSearch(resp.data.user.search);
  });
  ...
  console.log('sessio', sessionStorage);
  ...
  return (
    <div className="flex-dashboard">
      ...
      <div className="row gap-3 mt-3">
        ...
        >
          ...
          />
            ...
            <div style={{"textAlign":"right"}}>
              ...
              <img src="/imagens/right.svg" style={{
                "width": "35px",
                "height": "20px"}}></img>
            </div>
          </div>
        ...
        <div
          className="card border-light col-xl-3 col-lg-12 col-md-8 card-profile"
          style={{"padding": 0}}
        >
          <div
            className="card-img-top" 
            style={{"backgroundColor": "#9f9f9f", "padding": 10}}
          >
