...
const send_analysis = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield transporter.sendMail({
        ...
        * {
        ...
        <h3 class="v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 18px; "><strong>Dados do pedido:</strong></h3>
...
exports.send_analysis = send_analysis;
