...
const send_quotation = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield transporter
      ...
      * {
      ...
      <h1 class="v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 22px; "><strong>Novo pedido de cotação!<br /></strong></h1>
      ...
      <h3 class="v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 18px; "><strong>Dados para Cotação:</strong></h3>
      ...
      <div class="v-font-size" style="line-height: 140%; text-align: left; word-wrap: break-word;">
          <!-- <p style="line-height: 19.6px;"><strong>Armador:</strong> ${informacoesPedido.armador}</p>
          <p style="line-height: 19.6px;"><strong>Mercadoria:</strong> ${informacoesPedido.mercadoria}</p>
          <p style="line-height: 19.6px;"><strong>Tipo de mercadoria:</strong> ${informacoesPedido.tipo_mercadoria}</p> -->
          <p style="line-height: 19.6px;"><strong>Porto de embarque</strong> ${informacoesPedido.porto_embarque}</p>
          <p style="line-height: 19.6px;"><strong>Porto de descarga:</strong> ${informacoesPedido.porto_descarga}</p>
      ...
      <div class="v-font-size" style="line-height: 140%; text-align: left; word-wrap: break-word;">
          <p style="line-height: 19.6px;"><strong>Nome:</strong> ${informacoesPedido.embarcador_nome}</p>
          <p style="line-height: 19.6px;"><strong>Endereco:</strong> ${informacoesPedido.embarcador_endereco}</p>
          <p style="line-height: 19.6px;"><strong>Email:</strong> ${informacoesPedido.embarcador_email}</p>
          <p style="line-height: 19.6px;"><strong>Empresa:</strong> ${informacoesPedido.embarcador_empresa}</p>
          <p style="line-height: 19.6px;"><strong>CNPJ:</strong> ${informacoesPedido.embarcador_cnpj}</p>
          <p style="line-height: 19.6px;"><strong>Telefone:</strong> ${informacoesPedido.embarcador_telefone}</p>
      </div>
...
exports.send_quotation = send_quotation;
